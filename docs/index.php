                ...
                <tbody>
                    <tr>
                        <td class="teal-text" style="width:15%">
                            <b>Termo de Uso e Pol&iacute;tica de Privacidade</b><br /><!--<span style="color:#666; font-size:10px">06/05/2018</span>-->
                        </td>
                        <td class="blue-text">
                            Gerar o Termo de Uso ou Pol&iacute;tica de Privacidade para leitura.
                        </td>
                        <td class="right">
                            <a href="./metodo.php?m=legal.docs" class="btn-floating waves-effect waves-light red" style="padding-right:10px;"> 
